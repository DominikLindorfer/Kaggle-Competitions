# -*- coding: utf-8 -*-
"""
Created on Wed Jan 20 14:26:43 2021
...
def train(max_int: int = 16, batch_size: int = 2, training_steps: int = 5000):
...
# batch_size = 16 
    ...
    for i in range(training_steps):
        ...
        if i % 10 == 0:
            print(i, "  ", convert_float_matrix_to_int_list(generated_data))
